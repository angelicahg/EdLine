		...
		<table class="table table-bordered table-striped table-hover" id="myTable">
			<thead>
				<tr>
					...
					<th class="text-center" scope="col">Nombres y Apellido</th>
					<th class="text-center" scope="col">Id.Estudiante</th>
					<th class="text-center" scope="col">Numero de Telefono</th>
			...
			while ($row = mysqli_fetch_array($run_data)) {
				...
				<td class='text-center'>
					<span>
					<a href='#' class='btn btn-success mr-3 profile' data-toggle='modal' data-target='#view$id' title='Perfil Estidiante'><i class='fa fa-address-card-o' aria-hidden='true'></i></a>
					</span>
  ...
  <div class='modal-dialog'>
	...
	while ($row = mysqli_fetch_array($run_data)) {
		...
		<div class='modal-dialog'>
			<div class='modal-content'>
			<div class='modal-header'>
				<h5 class='modal-title' id='exampleModalLabel'>Prerfil <i class='fa fa-user-circle-o' aria-hidden='true'></i></h5>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
             <button type='button' class='close' data-dismiss='modal'>&times;</button>
             <h4 class='modal-title text-center'>Editar Datos del Estudiante</h4> 
      </div>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='inputEmail4'>Id.Estudiante.</label>
		<input type='text' class='form-control' name='card_no' placeholder='Enter 12-digit Id.Estudiante' maxlength='12' value='$card' required>
		</div>
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>No.Telefono</label>
		...
		<div class='form-group col-md-6'>
		<label for='aadharno'>No.CC</label>
		<input type='text' class='form-control' name='CC' maxlength='12' placeholder='Enter 12-digit Aadhar no. ' value='$aadhar'>
		</div>
		</div>
		...
		<div class='form-group'>
		<label for='family'>Miembros de la Familia </label>
